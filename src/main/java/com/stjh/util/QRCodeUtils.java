...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        String text = "9876543210,20200410111000,20200410143010,asdfkjfiuwern43471lsajlk989wajv4,MLSKADJFWIO2348942J3O47SJFDKLMVH";  //这里设置自定义网站url
        // 二维码中图片的logo地址
        String logoPath = "d:\\1.png";
        // 二维码存放的地址
        String destPath = "d:";
